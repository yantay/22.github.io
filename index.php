...
<link href="https://fonts.googleapis.com/css2?family=Caveat&display=swap" rel="stylesheet">
    <title>школа-гимназия №22</title>
</head>
<body>
    <div class="nav">
            <div class="logo">школа-гимназия №22</div>
             <div class="burger">
                    <span></span>
                </div>
            <div class="nav__items">
                <a id="one" class="list" href="#first"><div class="nav__item">О школе</div></a>
                <a id="two" class="list" href="#second"><div class="nav__item">Администрация</div></a>
                <a id="three" class="list" href="#third"><div class="nav__item">Родителям</div></a>
                <a id="four" class="list" href="#fourth"><div class="nav__item">Ученикам</div></a>
            ...
            <div class="lang">
                <a href="kz.php"><img src="kz.svg" alt=""></a>
                <a><img src="ru.svg" alt=""></a>
                <a href="en.php"><img src="en.svg" alt=""></a>
            </div>
        </div>        
    ...
    <div class="container" id="second">
        ...
        <a class="button" href="kz/">Записать ребенка</a>
